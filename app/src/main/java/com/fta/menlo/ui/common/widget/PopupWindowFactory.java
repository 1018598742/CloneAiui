package com.fta.menlo.ui.common.widget;
...
public class PopupWindowFactory {
    ...
    public PopupWindowFactory(Context context, View view) {
        this(context, view, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    }
     ...
     */
    public PopupWindowFactory(Context context, View view, int width, int heigth) {
        init(mContext, view, width, heigth);
    }

    private void init(Context context, View view, int width, int heigth) {
